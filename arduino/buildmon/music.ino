...
PROGMEM prog_uint16_t buzz_melody[] = { NOTE_G1, NOTE_G1,NOTE_G1, NOTE_DS1, NOTE_AS1,NOTE_G1,NOTE_DS1,NOTE_AS1,NOTE_G1 };
PROGMEM prog_uint16_t buzz_note_durations[] = { 2,2,2,4,4,2,4,4,2  };
int buzz_notes_to_play = 9;

PROGMEM prog_uint16_t beep_melody[] = { NOTE_E7, NOTE_E7, 0, NOTE_E7,   0, NOTE_C7, NOTE_E7, 0,  NOTE_G7, 0, 0,  0,  NOTE_G6, 0, 0, 0 };
PROGMEM prog_uint16_t beep_note_durations[] = { 12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12 };
